...
function addStudent() {
    ...
    if (nameValue == '' || emailValue == '' || ageValue == '' || gradeValue == '' || classValue == "") {
    ...
    students.forEach((student) => {
        ...
        keys.forEach((key) => {
            if (key == 'ID') {
                ...
                classElem.innerHTML = `<div class='degree'><div>${student[key]}</div> <div class="icons"><a onClick="edit(${student['ID']})" class='fa'>&#xf044;</a> <a onClick="del(${student['ID']})" class='fa'>&#xf1f8;</a> </div></div> `;
            row.appendChild(id);
